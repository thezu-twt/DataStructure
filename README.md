...
|Queue|[Queue製作](https://github.com/thezu-twt/DS/blob/main/Stack&Queue/Queue)|1) 利用Array<br>[法一]：Linear Array<br>[法二]：Circular Array (最多利用(n-1)格)<br>[法三]：Circular Array (最多利用n格)<br> 2) 利用Link List<br>[法一]：Single Link List<br>[法二]：Circular Link List<br>|Create(Q)<br>Isempty(Q)<br>IsFull(Q)<br>Enqueue(Q)<br>Dequeue(Q)<br>|
